...
public class BlockBreakListener implements Listener {
    private final ImmutableList<XMaterial> cropList = ImmutableList.of(
            XMaterial.WHEAT,
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        ...
        if (!cropList.contains(XMaterial.matchXMaterial(event.getBlock().getType()))) {
    ...
    private void applyReplant(@NotNull BlockBreakEvent event) {
        ...
        if (!cropList.contains(XMaterial.matchXMaterial(material))) {
    ...
    private boolean isRipe(@NotNull Block block) {
        return XBlock.getAge(block) == CropState.RIPE.getData();
    }
